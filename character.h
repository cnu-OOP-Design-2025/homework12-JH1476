...
public:
    Knight() { description = "Knight"; type = CharacterType::Knight; Logger::getInstance()->log("[Create] Knight");
    }
...
public:
    Wizard() { description = "Wizard"; type = CharacterType::Wizard; Logger::getInstance()->log("[Create] Wizard");
    }
...
public:
    Archer() { description = "Archer"; type = CharacterType::Archer; Logger::getInstance()->log("[Create] Archer");
    }
